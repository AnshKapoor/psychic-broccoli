...
from noise_simulation.automation.compare import mse_cumulative_res
...
def main() -> None:
    ...
    if args.aircraft_types:
        ...
        for t in args.aircraft_types:
            ...
            top10.append(NPD_TYPE_MAP.get(raw, raw))
    else:
    ...
    spectral_class = _relative_to_doc29(doc29_root, doc29_root / "Atmosphere_model" / "Spectral_classes.csv")
    height_arrival = _relative_to_doc29(doc29_root, doc29_root / "Flight_profiles" / "reference_arrival.csv")
    height_departure = _relative_to_doc29(doc29_root, doc29_root / "Flight_profiles" / "reference_departure.csv")
    ...
    for label_path in label_files:
        ...
        for cluster_id, cluster_df in labels_df.groupby("cluster_id"):
            ...
            for aircraft_type, flight_ids in flights_by_type.items():
                ...
                mse, n_rows = mse_cumulative_res(sub_out, gt_out)
                summary = {
                ...
                logger.info(
                    "MSE computed: flow=%s/%s cluster=%s type=%s mse=%.6f",
                    ad,
                    runway,
                    cluster_id,
                    aircraft_type,
